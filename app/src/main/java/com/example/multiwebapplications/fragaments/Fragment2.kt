...
class Fragment2 : Fragment() {
    ...
    private val viewModel: web2 by lazy {
        ViewModelProvider(requireActivity()).get(web2::class.java)
    }
    ...
    override fun onCreateView(
        ...
        if (context?.let {
            ...
            ActivityCompat.requestPermissions(
                ...
                Fragment2.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION
            )
        } else {
        ...
        when (requestCode) {
            REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    binding.website2.loadUrl("https://pdfcandy.com/")
    ...
    private fun downloadFile() {
        val request =
            DownloadManager.Request(Uri.parse("https://pdfcandy.com/"))
