...
import com.example.multiwebapplications.databinding.Fragment2Binding
...
class Fragment3 : Fragment() {
    ...
    private val viewModel: Fragment3.web3 by lazy {
        ViewModelProvider(requireActivity()).get(Fragment3.web3::class.java)
    }
    ...
    override fun onCreateView(
        ...
        if (viewModel.currentUrl.isNotEmpty()) {
            ...
            webView.loadUrl("https://poki.com/en/online")
        }
        ...
        if (context?.let {
            ...
            ActivityCompat.requestPermissions(
                ...
                Fragment3.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION
            )
        } else {
        ...
        when (requestCode) {
            Fragment3.REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    binding.website3.loadUrl("https://poki.com/en/online")
    ...
    private fun downloadFile() {
        val request =
            DownloadManager.Request(Uri.parse("https://poki.com/en/online"))
